...
<Procedure
  label="Events that should cause a re-read"
  settlesLabel="What it invalidates"
  steps={[
    {
      prompt: "An enemy buys a resistance item",
      settles: "That your damage still scales the way you assumed.",
    },
    {
      prompt: "An enemy buys anti-heal",
      settles: "Your team's sustain plan, immediately.",
    },
    {
      prompt: "A threat emerges from a champion you had discounted",
      settles: "Your priority target, and where you stand.",
    },
    {
      prompt: "An enemy augment or item changes their range or mobility",
      settles: "Whether you are actually safe where you are.",
    },
    {
      prompt: "Your team's frontline is dying first, repeatedly",
      settles: "Who the fight is actually being fought around.",
    },
    {
      prompt: "You stopped being able to kill somebody you used to kill",
      settles: "The whole build, usually.",
      emphasis: true,
    },
  ]}
  note="Unnumbered on purpose: these do not arrive in an order, and numbering them would claim a sequence the game does not follow."
/>
